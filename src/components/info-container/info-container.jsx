    ...
    return (
        <React.Fragment>
            <label htmlFor="emailEncypted"
                ...
                email</label>
            <textarea id="emailEncypted" aria-describedby="helper-text-explanation"
                   ...
                   dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 resize-none"
                   disabled/>
            ...
            <label htmlFor="passwordEncrypted"
                ...
                password</label>
            <textarea type="text" id="passwordEncrypted" aria-describedby="helper-text-explanation"
